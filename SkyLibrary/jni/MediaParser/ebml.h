...
uint32_t ebml_read_id (FILE *s, int *length);
uint64_t ebml_read_vlen_uint (uint8_t *buffer, int *length);
int64_t ebml_read_vlen_int (uint8_t *buffer, int *length);
uint64_t ebml_read_length (FILE *s, int *length);
uint64_t ebml_read_uint (FILE *s, uint64_t *length);
int64_t ebml_read_int (FILE *s, uint64_t *length);
long double ebml_read_float (FILE *s, uint64_t *length);
char *ebml_read_ascii (FILE *s, uint64_t *length);
char *ebml_read_utf8 (FILE *s, uint64_t *length);
int ebml_read_skip (FILE *s, uint64_t *length);
uint32_t ebml_read_master (FILE *s, uint64_t *length);
char *ebml_read_header (FILE *s, int *version);
