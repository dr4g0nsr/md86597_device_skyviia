...
BD_PRIVATE char* nav_find_main_title(const char *root, void *data);
BD_PRIVATE NAV_TITLE* nav_title_open(const char *root, const char *playlist, void *data);
...
BD_PRIVATE NAV_CLIP* nav_set_angle(NAV_TITLE *title, NAV_CLIP *clip, unsigned angle, void *data);

BD_PRIVATE NAV_TITLE_LIST* nav_get_title_list(const char *root, uint32_t flags, void *data);
