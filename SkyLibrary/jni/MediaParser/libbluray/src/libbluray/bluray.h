...
typedef struct bd_title_mpls_id {
    uint32_t             title_id;
    uint32_t             mpls_id;
} BLURAY_TITLE_MPLS_ID;

typedef struct bd_title_max_dur {
    uint32_t             dur_first_time;
    uint32_t             dur_second_time;
    uint32_t             dur_first_count;
    uint32_t             dur_second_count;
	BLURAY_TITLE_MPLS_ID *dur_first;
	BLURAY_TITLE_MPLS_ID *dur_second;
} BLURAY_TITLE_MAX_DUR;
