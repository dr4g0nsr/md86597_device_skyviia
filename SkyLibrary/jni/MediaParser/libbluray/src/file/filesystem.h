...
BD_DIR_H *dir_open_posix(const char* dirname, void *data);
...
typedef BD_FILE_H* (*BD_FILE_OPEN)(const char* filename, const char *mode, void *data);
typedef BD_DIR_H* (*BD_DIR_OPEN) (const char* dirname, void *data);
